  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-slate/50 bg-deep-black/90 backdrop-blur-md">
      <div className="mx-auto flex h-[4.75rem] w-full max-w-[80rem] items-center justify-between px-5 sm:px-8 lg:px-10">
        <a href="#main-content" aria-label="CybrLoop home" className="relative h-8 w-[8.75rem] shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal-orange focus-visible:ring-offset-4 focus-visible:ring-offset-deep-black sm:h-[2.15rem] sm:w-[9.4rem]">
